...
## This script requires a file with phone and external phone number mask data separated by comma.
## phone,external_phone_number_mask
        ...
        for dn_dest in f.readlines():
            ...
            if ',' in dn_dest:
                ...
                if update_phone_resp[0] == 200:
                    ...
                    loginfo = loginfo + "\nSuccess - Updated phone " + phone + " EPNM"
                else:
